...
// ArchiveAlarm archives an alarm. If the alarm is a root cause, all symptom
// alarms are also archived recursively.
func ArchiveAlarm(alarmId, archivedBy string, vnic ifs.IVNic) error {
	...
	// 3. If root cause, recursively archive symptom alarms
